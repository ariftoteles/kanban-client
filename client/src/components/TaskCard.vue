<template>
  <div class="bg-white shadow-sm rounded overflow-hidden mb-2" style="width: 17rem;"
      v-if="item.category == category">
    <div :id="item.id" class="d-flex justify-content-start">
      <div class="bg-secondary" style="padding-left: .25rem;"></div>
      <div class="p-3 w-100">
        <p v-if="!isEdit" class="overflow-hidden" style="font-size: .9rem;">{{ item.title }}</p>
        <div v-if="isEdit">
          <form action="" @submit.prevent="handleEditTask">
            <textarea type="text" class="form-control mb-2" style="font-size: .9rem;" v-model="item.title"></textarea>
            <div class="my-2">
        ...
        <div class="d-flex justify-content-between ">
          ...
          <div class="d-flex justify-content-between text-muted">
            <svg class="mx-2" style="width: 1rem; height: 1rem;" type="button" @click="isPatch = !isPatch"
            ...
            <svg class="mx-2" style="width: 1rem; height: 1rem;" type="button" @click="isEdit = !isEdit"
              xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
            </svg>
            <svg class="mx-2" style="width: 1rem; height: 1rem;" type="button" @click="deleteTask"
              xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
